...
const Test = () => {
  const {repeat, isPlaying, volume, currentTime, duration, visualizerData, setVolume, setTracks, nextTrack, togglePlay,  prevTrack, seekTo, toggleRepeat, toggleBassBoost, toggleReverb} = useAudio()
